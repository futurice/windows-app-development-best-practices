...
### Use Visual Studio Community/Pro or greater | #VS13 #W81 #C5
...
### Use [NuGet](http://www.nuget.org/) | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Refer to the right documentation | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Split code into small methods to improve stacktraces and the callstack view | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Use [caller information attributes](http://msdn.microsoft.com/en-us/library/hh534540(v=vs.110).aspx) when tracing | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Use [Windows.Web.Http.HttpClient](https://msdn.microsoft.com/en-US/library/windows/apps/xaml/windows.web.http.httpclient) for your HTTP needs | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Know the timers | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Use [yield](http://msdn.microsoft.com/en-us/library/9k7k7cf0.aspx) when returning an IEnumerable | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Explicitly convert LINQ queries into collections to avoid unnecessary re-evaluation | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### When rethrowing an exception use just "throw" or include the original exception in the new exception | #VS15 #VS13 #UWP #W81 #C6 #C5
...
### Log Exception.ToString() | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Catch exactly the exception you expect | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Only throw exceptions in _exceptional_ cases | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Use ContinueWith and Task.Exception to handle exceptions from async methods in expected cases | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Set Visual Studio to break debugger every time a CLR exception is thrown | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Use [CultureInfo.InvariantCulture](http://msdn.microsoft.com/en-us/library/system.globalization.cultureinfo.invariantculture) for serializations | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Uninstall the app installed from the store before trying to sideload the same app | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Do not hardcode a Name for your custom controls | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Be very careful when binding into multiple dependency properties of a dependency object | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Don't make forward references with StaticResource or ThemeResource keywords | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Use ItemsStackPanel over VirtualizingStackPanel | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Use independent animations over dependent ones | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Use [CallerMemberName](http://msdn.microsoft.com/en-us/library/system.runtime.compilerservices.callermembernameattribute(v=vs.110).aspx) attribute | #VS2015 #VS2013 #UWP #W81 #C6 #C5
...
### Use [LINQ expression](http://msdn.microsoft.com/en-us/library/system.linq.expressions.expression(v=vs.110).aspx) when notifying changes to other properties | #VS2015 #VS2013 #W81 #C5
...
### Use the nameof operator when notifying changes to other properties | #VS2015 #UWP #W81 #C6
